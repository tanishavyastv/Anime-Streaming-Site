...
function loadMoreSeries(button) {
  ...
  const loadMoreButton = button || document.querySelector('button[onclick="loadMoreSeries(this)"]');
  ...
  displayed += perLoad;
  if (loadMoreButton && displayed >= tvSeries.length) {
    loadMoreButton.style.display = "none";
  }
}

window.addEventListener("load", () => loadMoreSeries());
